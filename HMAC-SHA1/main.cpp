...
/********************************************/
 ...
 unsigned char digest[20]={0};//最终生成的缓存 算完之后是 20 字节的摘要信息(sha1 160bits 20bytes)
...
//HMAC https://blog.csdn.net/chengqiuming/article/details/82822933
{
    int b = 64; /* blocksize */
...
void hmac_sha1(){
    hmac_sha1((unsigned char*)"Ohohoh_Test", 11, (unsigned char*)"Buck_Boost", 10, digest);
	
    std::cout<<"hmac_base_sha1 ="<<std::endl;
